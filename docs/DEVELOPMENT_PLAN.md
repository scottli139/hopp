...
| 项目信息 | 详情 |
|----------|------|
| **当前阶段** | 战略转向：本地 + 私有 AI（M8 系列进行中：M8.0–M8.7 已完成并发布）；当前版本 v0.15.0（2026-09-02 发布）；下一步 M8.8（多语言 F5.9）→ M8.9（Tier 2 BYOK）→ M8.10（日常工效补齐）→ v1.0 GA |
| **目标版本** | v1.0.0 |
...
| M8.8 | 多语言完善（F5.9）：i18n 接线 + 全量字符串抽取 + 语言切换（2026-09-03 插队立项，界面中英文混杂痛点驱动） | P1 | ≈1.5 周 | ⏳ |
...
| v0.16.0（预计） | — | M8.8 多语言完善（F5.9 i18n 接线 + 全量字符串抽取 + 语言切换） | ⏳ |
