...
| 项目信息 | 详情 |
|----------|------|
| **当前阶段** | 战略转向：本地 + 私有 AI（M8 系列进行中：M8.0–M8.6 已完成并发布）；当前版本 v0.14.0（2026-09-01 发布），下一步 M8.7（Tier 2 BYOK） |
| **目标版本** | v1.0.0 |
...
| v0.14.0 | 2026-09-01 | **M8.6 时间戳工效增强**（F8.5：fx 动态变量直达、date_add/date_floor 管道时间函数、响应 epoch 人性化注解、Body 变量插入）+ 试用修复四波 | ✅ |
